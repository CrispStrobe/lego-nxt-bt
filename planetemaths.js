(function(Scratch) {
  ...
  const translations = {
    "en": {
      ...
      "text.c1": "units", "text.c2": "tens", "text.c3": "hundreds", "text.c4": "thousands",
      "text.c5": "tens of thousands", "text.c6": "hundreds of thousands", "text.c7": "millions",
      "text.c8": "tens of millions", "text.c9": "hundreds of millions", "text.c10": "billions",
      "text.c11": "tens of billions", "text.c12": "hundreds of billions",
      "text.d1": "tenths", "text.d2": "hundredths", "text.d3": "thousandths",
      "text.d4": "ten thousandths", "text.d5": "hundred thousandths", "text.d6": "millionths",
      "text.a0": "the unit", "text.a1": "tenth", "text.a2": "hundredth", "text.a3": "thousandth",
      "text.a4": "ten thousandth", "text.a5": "hundred thousandth", "text.a6": "millionth",
      "text.sqrt": "√", "text.abs": "abs", "text.sign": "sign", "text.floor": "floor", "text.ceil": "ceil",
      "text.ln": "ln", "text.log": "log", "text.exp": "e^", "text.pow10": "10^",
      "text.cos": "cos", "text.sin": "sin", "text.tan": "tan",
      "text.sec": "sec", "text.csc": "csc", "text.cot": "cot",
      "text.acos": "arccos", "text.asin": "arcsin", "text.atan": "arctan",
      "text.asec": "arcsec", "text.acsc": "arccsc", "text.acot": "arccot",
      "text.sinh": "sinh", "text.cosh": "cosh", "text.tanh": "tanh",
      "text.asinh": "arcsinh", "text.acosh": "arccosh", "text.atanh": "arctanh",
      "text.degrees": "degrees", "text.radians": "radians",
      "text.pgcd": "GCD", "text.ppcm": "LCM",
      "text.reste": "remainder", "text.quotient": "quotient",
      "text.vad": "Approximate value by defect of", "text.vae": "Approximate value by excess of", "text.arrondi": "Round",
      "text.multiple": "multiple", "text.diviseur": "divider"
    },
    "de": {
      "pm.title": "Mathe",
      "pm.add": "[NUM1] + [NUM2]",
      ...
      "text.c1": "Einer", "text.c2": "Zehner", "text.c3": "Hunderter", "text.c4": "Tausender",
      "text.c5": "Zehntausender", "text.c6": "Hunderttausender", "text.c7": "Millionen",
      "text.c8": "Zehnmillionen", "text.c9": "Hundertmillionen", "text.c10": "Milliarden",
      "text.c11": "Zehnmilliarden", "text.c12": "Hundertmilliarden",
      "text.d1": "Zehntel", "text.d2": "Hundertstel", "text.d3": "Tausendstel",
      "text.d4": "Zehntausendstel", "text.d5": "Hunderttausendstel", "text.d6": "Millionstel",
      "text.a0": "die Einerstelle", "text.a1": "die Zehntelstelle", "text.a2": "die Hundertstelstelle",
      "text.a3": "die Tausendstelstelle", "text.a4": "die Zehntausendstelstelle",
      "text.a5": "die Hunderttausendstelstelle", "text.a6": "die Millionstelstelle",
      "text.sqrt": "√", "text.abs": "Betrag", "text.sign": "Vorzeichen", "text.floor": "Abrunden", "text.ceil": "Aufrunden",
      "text.ln": "ln", "text.log": "log", "text.exp": "e^", "text.pow10": "10^",
      "text.cos": "cos", "text.sin": "sin", "text.tan": "tan",
      "text.sec": "sec", "text.csc": "csc", "text.cot": "cot",
      "text.acos": "arccos", "text.asin": "arcsin", "text.atan": "arctan",
      "text.asec": "arcsec", "text.acsc": "arccsc", "text.acot": "arccot",
      "text.sinh": "sinh", "text.cosh": "cosh", "text.tanh": "tanh",
      "text.asinh": "arsinh", "text.acosh": "arcosh", "text.atanh": "artanh",
      "text.degrees": "Grad", "text.radians": "Radiant",
      "text.pgcd": "ggT", "text.ppcm": "kgV",
      "text.reste": "Rest", "text.quotient": "Quotient",
      "text.vad": "Abgerundeter Wert von", "text.vae": "Aufgerundeter Wert von", "text.arrondi": "Runde",
      "text.multiple": "Vielfaches", "text.diviseur": "Teiler"
    },
    "fr": {
      "pm.title": "Maths",
      "pm.add": "[NUM1] + [NUM2]",
      ...
      "text.c1": "unités", "text.c2": "dizaines", "text.c3": "centaines", "text.c4": "unités de mille",
      "text.c5": "dizaines de mille", "text.c6": "centaines de mille", "text.c7": "unités de millions",
      "text.c8": "dizaines de millions", "text.c9": "centaines de millions", "text.c10": "unités de milliards",
      "text.c11": "dizaines de milliards", "text.c12": "centaines de milliards",
      "text.d1": "dixièmes", "text.d2": "centièmes", "text.d3": "millièmes",
      "text.d4": "dix-millièmes", "text.d5": "cent-millièmes", "text.d6": "millionièmes",
      "text.a0": "à l'unité", "text.a1": "au dixième", "text.a2": "au centième",
      "text.a3": "au millième", "text.a4": "au dix-millième", "text.a5": "au cent-millième", "text.a6": "au millionième",
      "text.sqrt": "√", "text.abs": "valeur absolue", "text.sign": "signe", "text.floor": "plancher", "text.ceil": "plafond",
      "text.ln": "ln", "text.log": "log", "text.exp": "e^", "text.pow10": "10^",
      "text.cos": "cos", "text.sin": "sin", "text.tan": "tan",
      "text.sec": "sec", "text.csc": "csc", "text.cot": "cot",
      "text.acos": "arccos", "text.asin": "arcsin", "text.atan": "arctan",
      "text.asec": "arcsec", "text.acsc": "arccsc", "text.acot": "arccot",
      "text.sinh": "sinh", "text.cosh": "cosh", "text.tanh": "tanh",
      "text.asinh": "argsinh", "text.acosh": "argcosh", "text.atanh": "argtanh",
      "text.degrees": "degrés", "text.radians": "radians",
      "text.pgcd": "PGCD", "text.ppcm": "PPCM",
      "text.reste": "reste", "text.quotient": "quotient",
      "text.vad": "valeur approchée par défaut de", "text.vae": "valeur approchée par excès de", "text.arrondi": "arrondi de",
      "text.multiple": "multiple", "text.diviseur": "diviseur"
    }
  };
  ...
  class PlaneteMaths {
      ...
      if (typeof window !== "undefined") {
        window.addEventListener("storage", (e) => {
          if (e.key === "tw:language") {
            console.log("[PlaneteMaths] TurboWarp language changed, re-detecting...");
            const newLang = detectLanguage();
            if (newLang !== this.locale) {
              this.locale = newLang;
              console.log("[PlaneteMaths] Language updated to:", this.locale);
              console.warn("[PlaneteMaths] Extension translations will apply after reload");
            }
          }
        });
          ...
          try {
            if (window.ReduxStore && window.ReduxStore.getState) {
              ...
              if (currentLocale && currentLocale !== lastKnownLocale) {
                ...
                console.log("[PlaneteMaths] Redux locale changed to:", currentLocale);
                
                const newLang = currentLocale.toLowerCase().startsWith("de") ? "de" : 
                               currentLocale.toLowerCase().startsWith("fr") ? "fr" : "en";
                if (newLang !== this.locale) {
                  this.locale = newLang;
                  console.log("[PlaneteMaths] Extension language updated to:", this.locale);
                  console.warn("[PlaneteMaths] Extension translations will apply after reload");
                }
              }
            }
      ...
      return {
        ...
        blocks: [
          ...
          '---',
          {
            ...
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              OPERATOR: { type: Scratch.ArgumentType.STRING, menu: 'LIST_MATHOP', defaultValue: 'sqrt' }
            }
          },
          {
            opcode: 'angleconvert',
            text: this._translate('pm.angleconvert', 'convert [NUM1] from [FROM] to [TO]'),
            blockType: Scratch.BlockType.REPORTER,
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '90' },
              FROM: { type: Scratch.ArgumentType.STRING, menu: 'ANGLE_UNITS', defaultValue: 'degrees' },
              TO: { type: Scratch.ArgumentType.STRING, menu: 'ANGLE_UNITS', defaultValue: 'radians' }
            }
          },
          '---',
          {
            opcode: 'mathopdiv',
            text: this._translate('pm.mathopdiv', '[OPERATOR] of [NUM1] divided by [NUM2]'),
            blockType: Scratch.BlockType.REPORTER,
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              NUM2: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              OPERATOR: { type: Scratch.ArgumentType.STRING, menu: 'LIST_MATHOPDIV', defaultValue: 'reste' }
            }
          },
          {
            opcode: 'mathop2',
            text: this._translate('pm.mathop2', '[OPERATOR] of [NUM1] and [NUM2]'),
            blockType: Scratch.BlockType.REPORTER,
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              NUM2: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              OPERATOR: { type: Scratch.ArgumentType.STRING, menu: 'LIST_MATHOP2', defaultValue: 'pgcd' }
            }
          },
          {
            opcode: 'multiple',
            text: this._translate('pm.multiple', '[NUM1] is a [choix1] of [NUM2]'),
            blockType: Scratch.BlockType.BOOLEAN,
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              NUM2: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              choix1: { type: Scratch.ArgumentType.STRING, menu: 'MULTIPLE_DIVISEUR', defaultValue: 'multiple' }
            }
          },
          '---',
          {
            ...
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              TYPE: { type: Scratch.ArgumentType.STRING, menu: 'ARRONDIS', defaultValue: 'arrondi' },
              CHIFFRE: { type: Scratch.ArgumentType.STRING, menu: 'CHIFFRE_ARRONDIS', defaultValue: '0' }
            }
          },
          '---',
          {
            ...
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              choix1: { type: Scratch.ArgumentType.STRING, menu: 'PARTIE_ENTIERE', defaultValue: '0' }
            }
          },
          {
            ...
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' },
              choix1: { type: Scratch.ArgumentType.STRING, menu: 'PARTIE_DECIMALE', defaultValue: '1' }
            }
          },
          {
            opcode: 'sommechiffres',
            text: this._translate('pm.sommechiffres', 'sum of digits of [NUM1]'),
            blockType: Scratch.BlockType.REPORTER,
            arguments: {
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '' }
            }
          ...
          '---',
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            arguments: {
              STRING1: { type: Scratch.ArgumentType.STRING, defaultValue: 'Planète ' },
              STRING2: { type: Scratch.ArgumentType.STRING, defaultValue: 'Maths' }
            }
          },
          {
            opcode: 'letterOf',
            ...
            blockType: Scratch.BlockType.REPORTER,
            arguments: {
              STRING: { type: Scratch.ArgumentType.STRING, defaultValue: 'Maths' },
          ...
          {
            opcode: 'contains',
            text: this._translate('pm.contains', '[STRING1] contains [STRING2] ?'),
            blockType: Scratch.BlockType.BOOLEAN,
            arguments: {
              STRING1: { type: Scratch.ArgumentType.STRING, defaultValue: 'Maths' },
              STRING2: { type: Scratch.ArgumentType.STRING, defaultValue: 's' }
            }
          },
          {
            opcode: 'extract',
            text: this._translate('pm.extract', 'extract characters from [NUM1] to [NUM2] of [STRING]'),
            blockType: Scratch.BlockType.REPORTER,
            arguments: {
              STRING: { type: Scratch.ArgumentType.STRING, defaultValue: 'Planète Maths' },
              NUM1: { type: Scratch.ArgumentType.NUMBER, defaultValue: '1' },
        ...
        menus: {
          PARTIE_ENTIERE: {
            ...
            items: [
              ...
              { text: this._translate('text.c5', 'tens of thousands'), value: '4' },
              { text: this._translate('text.c6', 'hundreds of thousands'), value: '5' },
              { text: this._translate('text.c7', 'millions'), value: '6' },
              { text: this._translate('text.c8', 'tens of millions'), value: '7' },
              { text: this._translate('text.c9', 'hundreds of millions'), value: '8' },
              { text: this._translate('text.c10', 'billions'), value: '9' },
              { text: this._translate('text.c11', 'tens of billions'), value: '10' },
              { text: this._translate('text.c12', 'hundreds of billions'), value: '11' }
            ]
          },
          PARTIE_DECIMALE: {
            acceptReporters: true,
            items: [
              ...
              { text: this._translate('text.d4', 'ten thousandths'), value: '4' },
              { text: this._translate('text.d5', 'hundred thousandths'), value: '5' },
          ...
          CHIFFRE_ARRONDIS: {
            ...
            items: [
              ...
              { text: this._translate('text.a4', 'ten thousandth'), value: '4' },
              { text: this._translate('text.a5', 'hundred thousandth'), value: '5' },
          ...
          LIST_MATHOP: {
            ...
            items: [
              ...
              { text: this._translate('text.asinh', 'arcsinh'), value: 'asinh' },
              { text: this._translate('text.acosh', 'arccosh'), value: 'acosh' },
              { text: this._translate('text.atanh', 'arctanh'), value: 'atanh' }
            ]
          },
          ANGLE_UNITS: {
            acceptReporters: true,
            items: [
              { text: this._translate('text.degrees', 'degrees'), value: 'degrees' },
              { text: this._translate('text.radians', 'radians'), value: 'radians' }
            ]
          },
          LIST_MATHOP2: {
            acceptReporters: true,
          ...
          LIST_MATHOPDIV: {
            acceptReporters: true,
            items: [
              { text: this._translate('text.reste', 'remainder'), value: 'reste' },
              { text: this._translate('text.quotient', 'quotient'), value: 'quotient' }
            ]
          },
          ARRONDIS: {
            acceptReporters: true,
            items: [
              { text: this._translate('text.vad', 'Approximate value by defect of'), value: 'vad' },
              { text: this._translate('text.vae', 'Approximate value by excess of'), value: 'vae' },
              { text: this._translate('text.arrondi', 'Round'), value: 'arrondi' }
            ]
          },
          MULTIPLE_DIVISEUR: {
            acceptReporters: true,
            items: [
              { text: this._translate('text.multiple', 'multiple'), value: 'multiple' },
              { text: this._translate('text.diviseur', 'divider'), value: 'diviseur' }
            ]
          }
        }
      };
    ...
    pow(args) {
      try {
        const result = Math.pow(Cast.toNumber(args.NUM1), Cast.toNumber(args.NUM2));
    ...
    min(args) {
      try {
        const result = Math.min(Cast.toNumber(args.NUM1), Cast.toNumber(args.NUM2));
    ...
    max(args) {
      try {
        const result = Math.max(Cast.toNumber(args.NUM1), Cast.toNumber(args.NUM2));
    ...
    and(args) {
      try {
        const result = Cast.toBoolean(args.OPERAND1) && Cast.toBoolean(args.OPERAND2);
    ...
    chiffre_pentiere(args) {
      try {
        ...
        const result = Math.floor(num / Math.pow(10, pos)) - 
    ...
    join(args) {
      try {
        const result = Cast.toString(args.STRING1) + Cast.toString(args.STRING2);
