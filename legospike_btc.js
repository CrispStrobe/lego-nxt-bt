    ...
    class SpikePrimeBTC {
        constructor(runtime, extensionId) {
            ...
            SpikePorts.forEach(p => {
                this.portValues[p] = { type: 'unknown', position: 0, distance: 0, color: 255, force: 0, pressed: false };
            });
...
`;
    ...
    class SpikePrimeBTCExtension {
        ...
        connectHub() { return this.peripheral.connectHub(); }
        disconnectHub() { return this.peripheral.disconnectHub(); }
